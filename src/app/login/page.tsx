...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.user?.role) {
        console.log("Role found in login response:", result.user.role);
        ...
        console.log("Role not found in login response, fetching user data...");
        // Fallback: Fetch user data if role is not in login response
        ...
        console.log("User result keys:", Object.keys(userResult));
        console.log("============================");
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <button
                  type="button"
                  className="w-full inline-flex items-center justify-center py-2 px-4 rounded-md shadow-sm bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"
                >
                ...
                <button
                  type="button"
                  className="w-full inline-flex items-center justify-center py-2 px-4 rounded-md shadow-sm bg-[#1877F2] text-white hover:bg-[#166FE5]"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
